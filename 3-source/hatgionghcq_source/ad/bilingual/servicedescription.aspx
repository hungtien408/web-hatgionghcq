<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="servicedescription.aspx.cs" Inherits="ad_single_productcategory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
        ...
        <asp:RadGrid ID="RadGrid1" AllowMultiRowSelection="True" runat="server" Culture="vi-VN"
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                <Columns>
                    ...
                    <asp:GridTemplateColumn DataField="ProductCategoryName" HeaderText="Tên danh mục">
                        <ItemTemplate>
                ...
                <EditFormSettings EditFormType="Template">
                    ...
                    <FormTemplate>
                        <asp:Panel ID="Panel1" runat="server" DefaultButton="lnkUpdate">
                            <h3 class="searchTitle">Thông Tin Mô Tả Dịch Vụ & Giải Pháp</h3>
                            <table class="search">
                                <tr class="invisible">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:RadTextBox ID="txtProductCategoryName" runat="server" Text='<%# Eval("ProductCategoryName") %>'
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="ProductCategoryDelete"
        SelectMethod="ProductCategorySelectOne" TypeName="TLLib.ProductCategory" UpdateMethod="ProductCategoryUpdate"
