        ...
        jcarouselbox: function (options) {
            ...
            return this.each(function () {
                ...
                jcarousel.on('jcarousel:reload jcarousel:create', function () {
                    ...
                    carousel.jcarousel('items').css('width', parseInt(widthw) + 'px');
                    $(this).width(Math.ceil(widthw) * numli);
                    if (numli < countli) {
                        $(this).parent().find(".navigation-btn").removeClass('inactive-none');
                    } else {
        ...
        jcalistzoom: function (options) {
            ...
            return this.each(function () {
                ...
                jcarousel.on('jcarousel:reload jcarousel:create', function () {
                        ...
                        obj.width(parseInt(widths) * numcount);
    ...
    $.fn.extend({
        ...
        jcarouselzoom: function (options) {
            ...
            return this.each(function () {
                ...
                var obj = $(this);
                var opts = options;
                var jcarousel = $('.carousel-stage', obj);
                var jcarouselthums = $('.carousel-navigation', obj);
                jcarousel.on('jcarousel:reload jcarousel:create', function () {
                    var carousel = $(this);
                    carousel.width("auto");
                    setTimeout(function () {
                        var widtha = carousel.width();
                        carousel.width(widtha).jcarousel('items').css('width', widtha + 'px');
                        if (opts.usezoom) {
                ...
                jcarouselthums.on('jcarousel:reload jcarousel:create', function () {
                    ...
                    carousel.width("auto");
                    setTimeout(function () {
                        widths = parseInt(carousel.width() / opts.shownum);
                        if (numli > opts.shownum) {
                            obj.find(".navigation-btn").removeClass('inactive-none');
                        ...
                        carousel.width(widths * numcount).jcarousel('items').width(widths);
                    }, 100);
                });
                // Thêm sự kiện
                var carouselStage = obj.find('.carousel-stage').jcarousel({
