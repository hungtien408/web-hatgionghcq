...
//Thay dia chi web
var endAddress = "10.746273, 106.612312";
//Thay toa do
var lat = 10.746273, long = 106.612312;
window.onload = function () {
    ...
    google.maps.event.addListener(marker, 'click', function () {
        ...
        var content = '<div class="box">' +
            '<h4>HẠT GIỐNG</h4>' +
            '<p><span class="fa fa-map-marker"></span>111 Tên Lửa, P.Bình Trị Đông, Q.Bình Tân</p>' +            '<p><span class="fa fa-phone"></span>08.3856.1489 - 0907 018 309</p>' +
        '</div>';
